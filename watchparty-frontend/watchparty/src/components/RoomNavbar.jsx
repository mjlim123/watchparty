...
export default function RoomNavbar({ roomCode }) {
    ...
    return (
        <div className="navbar fixed top-0 left-0 w-full z-50 bg-[#1E293B] flex justify-between items-center p-4">
            <div className="flex items-center gap-4">
                <a href="/" className="pl-5 opacity-80 hover:animate-bounce opacity-100 transition duration-300 text-3xl font-bold">Watchparty</a>
